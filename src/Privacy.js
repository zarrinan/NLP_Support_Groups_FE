  ...
  render() {
    return (
      <div>
        ...
        on your activities when visiting our Website, you may be required to agree to additional
        terms and conditions.</p>
            <h2>Website Visitors</h2>
      <p>Like most website operators, NLP Support Groups Finder collects non-personally-identifying
      information of the sort that web browsers and servers typically make available, such as the browser
      type, language preference, referring site, and the date and time of each visitor request. Portfolio
      Projects Website’s purpose in collecting non-personally identifying information is to better understand
      how NLP Support Groups Finder’s visitors use its website. From time to time, NLP Support Groups Finder
      ...
      <p>NLP Support Groups Finder may collect statistics about the behavior of visitors to its website.
      NLP Support Groups Finder may display this information publicly or provide it to others. However,
      NLP Support Groups Finder does not disclose your personally-identifying information.</p>
            <h2>Cookies</h2>
      <p>To enrich and perfect your online experience, NLP Support Groups Finder uses "Cookies",
      similar technologies and services provided by others to display personalized content, appropriate
      ...
      acknowledge and agree to NLP Support Groups Finder's use of cookies.</p>
